...
void ASplineFollow::Follow()
{
	...
	FVector ForwardVector = UKismetMathLibrary::GetForwardVector(Rotator) * 300; // distance of leading object from AI.
	...
	float MapRangeUnclamped = UKismetMathLibrary::MapRangeUnclamped(Speed*XYSize, 0, 1000, 1, 0.5);
